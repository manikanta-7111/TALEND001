...
package talend001.header_footer_limit_11_0_1;
...
/**
 * Job: header_footer_limit_11 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class header_footer_limit_11 implements TalendJob {
	...
	private final String jobName = "header_footer_limit_11";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					header_footer_limit_11.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(header_footer_limit_11.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALEND001_header_footer_limit_11 = new byte[0];
		static byte[] commonByteArray_TALEND001_header_footer_limit_11 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND001_header_footer_limit_11.length) {
					if (length < 1024 && commonByteArray_TALEND001_header_footer_limit_11.length == 0) {
						commonByteArray_TALEND001_header_footer_limit_11 = new byte[1024];
					} else {
						commonByteArray_TALEND001_header_footer_limit_11 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND001_header_footer_limit_11, 0, length);
				strReturn = new String(commonByteArray_TALEND001_header_footer_limit_11, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND001_header_footer_limit_11) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:BF4SZ19tkHs19nqXN3UayZTZQgEUMFZG9GVmeZXH8Wg=");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("header_footer_limit_11_01");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("header_footer_limit_11_01");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "header_footer_limit_11_01") + "";
				...
				int limit_tFileInputDelimited_1 = 100;
				try {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:0ZgyfD+13A3e3CXVblW+lMsAfoxieO2JQJX+lv8Au9w=");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("header_footer_limit_11_02");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "." + ("header_footer_limit_11_02");
				}
				String tableNameForSearch_tDBOutput_2 = "" + ((String) "header_footer_limit_11_02") + "";
				...
				int limit_tFileInputDelimited_2 = 200;
				try {
					...
					if (filename_tFileInputDelimited_2 instanceof java.io.InputStream) {
						...
						int footer_value_tFileInputDelimited_2 = 1, random_value_tFileInputDelimited_2 = -1;
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/employe.txt",
								"US-ASCII", ",", "\n", false, 101, 1, limit_tFileInputDelimited_2, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"empno", "row2", temp, ex_tFileInputDelimited_2),
							...
							row2.empname = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"deptno", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.deptname = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row2.loc = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (row2.empno == null) {
								...
								pstmt_tDBOutput_2.setInt(1, row2.empno);
							}

							if (row2.empname == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row2.empname);
							}

							if (row2.sal == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(3, row2.sal);
							}

							if (row2.HRA == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(4, row2.HRA);
							}

							if (row2.deptno == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_2.setInt(5, row2.deptno);
							}

							if (row2.deptname == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(6, row2.deptname);
							}

							if (row2.loc == null) {
								pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(7, row2.loc);
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:VnSK05kxbTAjB6x/oMRvOYQr9wpaWj2uSOBCRRInrZ4=");
				...
				if (dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
					tableName_tDBOutput_3 = ("header_footer_limit_11_03");
				} else {
					tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "." + ("header_footer_limit_11_03");
				}
				String tableNameForSearch_tDBOutput_3 = "" + ((String) "header_footer_limit_11_03") + "";
				...
				int limit_tFileInputDelimited_3 = 300;
				try {

					Object filename_tFileInputDelimited_3 = "C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/employe.txt";
					if (filename_tFileInputDelimited_3 instanceof java.io.InputStream) {

						int footer_value_tFileInputDelimited_3 = 1, random_value_tFileInputDelimited_3 = -1;
					...
					try {
						fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/employe.txt",
								"US-ASCII", ",", "\n", false, 201, 1, limit_tFileInputDelimited_3, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"empno", "row3", temp, ex_tFileInputDelimited_3),
							...
							row3.empname = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"HRA", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"deptno", "row3", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row3.deptname = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							row3.loc = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// Start of branch "row3"
	...
	public static void main(String[] args) {
		final header_footer_limit_11 header_footer_limit_11Class = new header_footer_limit_11();

		int exitCode = header_footer_limit_11Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = header_footer_limit_11.class.getClassLoader()
					.getResourceAsStream("talend001/header_footer_limit_11_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = header_footer_limit_11.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : header_footer_limit_11");
		}
...
/************************************************************************************************
 * 114910 characters generated by Talend Open Studio for Data Integration on the
 * 1 July 2026 at 4:11:35 PM IST
 ************************************************************************************************/