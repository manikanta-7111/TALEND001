...
package talend001.tnormalise_s8_0_1;
 ...
 * @status
 */
public class tnormalise_S8 implements TalendJob {
	...
	private final String jobName = "tnormalise_S8";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					tnormalise_S8.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tnormalise_S8.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALEND001_tnormalise_S8 = new byte[0];
		static byte[] commonByteArray_TALEND001_tnormalise_S8 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND001_tnormalise_S8.length) {
					if (length < 1024 && commonByteArray_TALEND001_tnormalise_S8.length == 0) {
						commonByteArray_TALEND001_tnormalise_S8 = new byte[1024];
					} else {
						commonByteArray_TALEND001_tnormalise_S8 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND001_tnormalise_S8, 0, length);
				strReturn = new String(commonByteArray_TALEND001_tnormalise_S8, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND001_tnormalise_S8) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:pSYNQqnyfIsD5PXIYGDyNOWe4QKKQAWE//fH8kOScLU=");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("tnormalize_S8");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("tnormalize_S8");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "tnormalize_S8") + "";
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
							+ "(empno INT ,ename VARCHAR2(30)  ,skills VARCHAR2(40)  )");
				}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.skills != null) {
								if ("".equals(row1.skills)) {
									normalizeRecord_tNormalize_1[0] = "";
								} else {

									normalizeRecord_tNormalize_1 = row1.skills.split(";", -1);
							...
							for (int i_tNormalize_1 = 0; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1; i_tNormalize_1++) {
								...
								tmp_tNormalize_1 = row1.empno == null ? null : row1.empno.toString();

								if (tmp_tNormalize_1 != null) {
									currentRecord_tNormalize_1.append(tmp_tNormalize_1 + tmp_tNormalize_1.length());
								}

								tmp_tNormalize_1 = row1.ename == null ? null : String.valueOf(row1.ename);
	...
	public static void main(String[] args) {
		final tnormalise_S8 tnormalise_S8Class = new tnormalise_S8();

		int exitCode = tnormalise_S8Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tnormalise_S8.class.getClassLoader()
					.getResourceAsStream("talend001/tnormalise_s8_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tnormalise_S8.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tnormalise_S8");
		}
...
/************************************************************************************************
 * 55277 characters generated by Talend Open Studio for Data Integration on the
 * 1 July 2026 at 11:46:15 PM IST
 ************************************************************************************************/