...
package talend001.tdenormalize_s8_0_1;
...
/**
 * Job: tdenormalize_S8 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class tdenormalize_S8 implements TalendJob {
	...
	private final String jobName = "tdenormalize_S8";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					tdenormalize_S8.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tdenormalize_S8.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALEND001_tdenormalize_S8 = new byte[0];
		static byte[] commonByteArray_TALEND001_tdenormalize_S8 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND001_tdenormalize_S8.length) {
					if (length < 1024 && commonByteArray_TALEND001_tdenormalize_S8.length == 0) {
						commonByteArray_TALEND001_tdenormalize_S8 = new byte[1024];
					} else {
						commonByteArray_TALEND001_tdenormalize_S8 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND001_tdenormalize_S8, 0, length);
				strReturn = new String(commonByteArray_TALEND001_tdenormalize_S8, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND001_tdenormalize_S8) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.util.Map<Integer, java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>> hash_empno_tDenormalize_1_DenormalizeOut = new java.util.HashMap<Integer, java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut>>();
				java.util.Map<String, DenormalizeStructtDenormalize_1_DenormalizeOut> hash_ename_tDenormalize_1_DenormalizeOut = null;
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/dinormalizer.txt";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/dinormalizer.txt",
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.skills = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (hash_empno_tDenormalize_1_DenormalizeOut.containsKey(row1.empno)) {
								hash_ename_tDenormalize_1_DenormalizeOut = hash_empno_tDenormalize_1_DenormalizeOut
										.get(row1.empno);
							} else {
								hash_ename_tDenormalize_1_DenormalizeOut = new java.util.HashMap<String, DenormalizeStructtDenormalize_1_DenormalizeOut>();
								hash_empno_tDenormalize_1_DenormalizeOut.put(row1.empno,
										hash_ename_tDenormalize_1_DenormalizeOut);
							}
							if (hash_ename_tDenormalize_1_DenormalizeOut.containsKey(row1.ename)) {
								denormalize_result_tDenormalize_1_DenormalizeOut = hash_ename_tDenormalize_1_DenormalizeOut
										.get(row1.ename);
								if (!denormalize_result_tDenormalize_1_DenormalizeOut.skills.contains(row1.skills)) {
									denormalize_result_tDenormalize_1_DenormalizeOut.skills.add(row1.skills);
								}
							} else {
								...
								hash_ename_tDenormalize_1_DenormalizeOut.put(row1.ename,
					...
					if (!((Object) ("C:/Users/Sontanam Manikanta/Desktop/Talend/Talend Files/12AM-20260610T043604Z-3-001/12AM/dinormalizer.txt") instanceof java.io.InputStream)) {
...
//generate result begin
					java.util.Iterator<Integer> empno_iterator_tDenormalize_1_DenormalizeOut = hash_empno_tDenormalize_1_DenormalizeOut
							.keySet().iterator();

					while (empno_iterator_tDenormalize_1_DenormalizeOut.hasNext()) {

						Integer key_empno_tDenormalize_1_DenormalizeOut = empno_iterator_tDenormalize_1_DenormalizeOut
								.next();

						hash_ename_tDenormalize_1_DenormalizeOut = hash_empno_tDenormalize_1_DenormalizeOut
								.get(key_empno_tDenormalize_1_DenormalizeOut);

						java.util.Iterator<String> ename_iterator_tDenormalize_1_DenormalizeOut = hash_ename_tDenormalize_1_DenormalizeOut
								.keySet().iterator();

						while (ename_iterator_tDenormalize_1_DenormalizeOut.hasNext()) {

							String key_ename_tDenormalize_1_DenormalizeOut = ename_iterator_tDenormalize_1_DenormalizeOut
									.next();

							denormalize_result_tDenormalize_1_DenormalizeOut = hash_ename_tDenormalize_1_DenormalizeOut
									.get(key_ename_tDenormalize_1_DenormalizeOut);

							OnRowsEndStructtDenormalize_1 denormalize_row_tDenormalize_1_DenormalizeOut = new OnRowsEndStructtDenormalize_1();

							denormalize_row_tDenormalize_1_DenormalizeOut.empno = key_empno_tDenormalize_1_DenormalizeOut;
							denormalize_row_tDenormalize_1_DenormalizeOut.ename = key_ename_tDenormalize_1_DenormalizeOut;
							for (String temp_tDenormalize_1_DenormalizeOut : denormalize_result_tDenormalize_1_DenormalizeOut.skills) {
								...
								if (sb_tDenormalize_1_DenormalizeOut == null) {
									...
									sb_tDenormalize_1_DenormalizeOut.append(";")
							...
							denormalize_row_tDenormalize_1_DenormalizeOut.skills = sb_tDenormalize_1_DenormalizeOut
									.toString();
...
//generate result end
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:91Mz40vaPSBjTyXJOXSdeGuQkir9IF7t/N4YbVFDOeU=");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("tdenormalize_S8");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("tdenormalize_S8");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "tdenormalize_S8") + "";
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
							+ "(empno INT ,ename VARCHAR2(6)  ,skills VARCHAR2(300)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (empno,ename,skills) VALUES (?,?,?)";
				...
				for (OnRowsEndStructtDenormalize_1 row_tDenormalize_1_ArrayIn : list_tDenormalize_1_ArrayIn) {
					...
					row2.empno = row_tDenormalize_1_ArrayIn.empno;

					row2.ename = row_tDenormalize_1_ArrayIn.ename;

					row2.skills = row_tDenormalize_1_ArrayIn.skills;
					...
					if (row2.empno == null) {
						...
						pstmt_tDBOutput_1.setInt(1, row2.empno);
					}

					if (row2.ename == null) {
						pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(2, row2.ename);
					}

					if (row2.skills == null) {
						pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(3, row2.skills);
					}
	...
	public static void main(String[] args) {
		final tdenormalize_S8 tdenormalize_S8Class = new tdenormalize_S8();

		int exitCode = tdenormalize_S8Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tdenormalize_S8.class.getClassLoader()
					.getResourceAsStream("talend001/tdenormalize_s8_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = tdenormalize_S8.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : tdenormalize_S8");
		}
...
/************************************************************************************************
 * 64669 characters generated by Talend Open Studio for Data Integration on the
 * 2 July 2026 at 12:27:15 AM IST
 ************************************************************************************************/