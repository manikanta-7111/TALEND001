...
package talend001.context_s22_0_1;
 ...
 * @status
 */
public class context_S22 implements TalendJob {
	...
	private final String jobName = "context_S22";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(context_S22.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row_Implicit_Context_RegexStruct
		...
		final static byte[] commonByteArrayLock_TALEND001_context_S22 = new byte[0];
		static byte[] commonByteArray_TALEND001_context_S22 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND001_context_S22.length) {
					if (length < 1024 && commonByteArray_TALEND001_context_S22.length == 0) {
						commonByteArray_TALEND001_context_S22 = new byte[1024];
					} else {
						commonByteArray_TALEND001_context_S22 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND001_context_S22, 0, length);
				strReturn = new String(commonByteArray_TALEND001_context_S22, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND001_context_S22) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("table1_S22");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("table1_S22");
				}
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "table1_S22") + "";
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row1.empno == null) {
								...
								pstmt_tDBOutput_1.setInt(1, row1.empno);
							}

							if (row1.empname == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, row1.empname);
							}
							...
							if (row1.HRA == null) {
								...
								pstmt_tDBOutput_1.setInt(4, row1.HRA);
							}

							if (row1.deptno == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(5, row1.deptno);
							}

							if (row1.deptname == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, row1.deptname);
							}

							if (row1.loc == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, row1.loc);
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("table2_S22");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "." + ("table2_S22");
				}
				String tableNameForSearch_tDBOutput_2 = "" + ((String) "table2_S22") + "";
				...
				try (java.sql.Statement stmtCreate_tDBOutput_2 = conn_tDBOutput_2.createStatement()) {
					stmtCreate_tDBOutput_2.execute("CREATE TABLE " + tableName_tDBOutput_2
							+ "(eno INT ,ename VARCHAR2(30)  ,mobilenum VARCHAR2(30)  ,mailid VARCHAR2(30)  )");
				}
				String insert_tDBOutput_2 = "INSERT INTO " + tableName_tDBOutput_2
						+ " (eno,ename,mobilenum,mailid) VALUES (?,?,?,?)";
...
// Start of branch "row2"
						if (row2 != null) {
							...
							if (row2.eno == null) {
								...
								pstmt_tDBOutput_2.setInt(1, row2.eno);
							}

							if (row2.ename == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row2.ename);
							}

							if (row2.mobilenum == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row2.mobilenum);
							}

							if (row2.mailid == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(4, row2.mailid);
							}
	...
	public static void main(String[] args) {
		final context_S22 context_S22Class = new context_S22();

		int exitCode = context_S22Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = context_S22.class.getClassLoader()
					.getResourceAsStream("talend001/context_s22_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = context_S22.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : context_S22");
		}
...
/************************************************************************************************
 * 102147 characters generated by Talend Open Studio for Data Integration on the
 * 4 August 2026 at 11:11:58 PM IST
 ************************************************************************************************/